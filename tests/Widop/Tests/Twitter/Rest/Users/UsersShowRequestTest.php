...
/**
 * Users show request test.
 *
 * @author Geoffrey Brier <geoffrey.brier@gmail.com>
 */
class UsersShowRequestTest extends AbstractRequestTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        parent::setUp();
        $this->request = new UsersShowRequest($this->optionBagFactory);
    }
    ...
    public function testOAuthRequestWithUserId()
    {
        ...
        $this->assertSame('/users/show.json', $oauthRequest->getPath());
