...
/**
 * Users contributees request test.
 *
 * @author Geoffrey Brier <geoffrey.brier@gmail.com>
 */
class UsersContributeesRequestTest extends AbstractRequestTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        parent::setUp();
        $this->request = new UsersContributeesRequest($this->optionBagFactory);
    }
    ...
    public function testOAuthRequestWithUserId()
    {
        ...
        $this->assertSame('/users/contributees.json', $oauthRequest->getPath());
