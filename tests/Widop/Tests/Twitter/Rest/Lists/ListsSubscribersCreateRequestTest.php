...
/**
 * Lists subscribers create request test.
 *
 * @author Geoffrey Brier <geoffrey.brier@gmail.com>
 */
class ListsSubscribersCreateRequestTest extends AbstractRequestTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        parent::setUp();
        $this->request = new ListsSubscribersCreateRequest($this->optionBagFactory);
    }
    ...
    public function testOAuthRequestWithListId()
    {
        ...
        $this->assertSame('/lists/subscribers/create.json', $oauthRequest->getPath());
