...
/**
 * Lists subscribers destroy request test.
 *
 * @author Geoffrey Brier <geoffrey.brier@gmail.com>
 */
class ListsSubscribersDestroyRequestTest extends AbstractRequestTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        parent::setUp();
        $this->request = new ListsSubscribersDestroyRequest($this->optionBagFactory);
    }
    ...
    public function testOAuthRequestWithListId()
    {
        ...
        $this->assertSame('/lists/subscribers/destroy.json', $oauthRequest->getPath());
