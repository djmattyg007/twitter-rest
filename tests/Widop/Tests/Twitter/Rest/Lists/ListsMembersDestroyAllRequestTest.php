...
/**
 * Lists members destroy all request test.
 *
 * @author Geoffrey Brier <geoffrey.brier@gmail.com>
 */
class ListsMembersDestroyAllRequestTest extends AbstractRequestTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        parent::setUp();
        $this->request = new ListsMembersDestroyAllRequest($this->optionBagFactory);
    }
    ...
    public function testOAuthRequestWithListId()
    {
        ...
        $this->assertSame('/lists/members/destroy_all.json', $oauthRequest->getPath());
