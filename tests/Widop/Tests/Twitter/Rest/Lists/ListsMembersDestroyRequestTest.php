...
/**
 * Lists members destroy request test.
 *
 * @author Geoffrey Brier <geoffrey.brier@gmail.com>
 */
class ListsMembersDestroyRequestTest extends AbstractRequestTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        parent::setUp();
        $this->request = new ListsMembersDestroyRequest($this->optionBagFactory);
    }
    ...
    public function testOAuthRequestWithListId()
    {
        ...
        $this->assertSame('/lists/members/destroy.json', $oauthRequest->getPath());
