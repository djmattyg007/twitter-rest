...
/**
 * Friends list request test.
 *
 * @author Geoffrey Brier <geoffrey.brier@gmail.com>
 */
class FriendsListRequestTest extends AbstractRequestTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        parent::setUp();
        $this->request = new FriendsListRequest($this->optionBagFactory);
    }
    ...
    public function testOAuthRequestWithParameters()
    {
        ...
        $this->assertSame('/friends/list.json', $oauthRequest->getPath());
